...
owner.add = function(a, b) {
    ...
    return e = Math.pow(10, Math.max(c, d)), (owner.mul(a, e) + owner.mul(b, e)) / e;
}
 
owner.sub = function(a, b) {
    var c, d, e;
    try {
        c = a.toString().split(".")[1].length;
    } catch (f) {
...
owner.div = function (a, b) {
    ...
    return c = Number(a.toString().replace(".", "")), d = Number(b.toString().replace(".", "")), owner.mul(c / d, Math.pow(10, f - e));
}
